...
testF_array = []
testUF_array = []
Fpath = "/content/drive/MyDrive/Colab_Notebooks/DataSet/KoKo/F/"
UnFpath= "/content/drive/MyDrive/Colab_Notebooks/DataSet/KoKo/UF/"
for i in os.listdir(Fpath):
  image = cv2.imread(Fpath + i)
  frame= image 
  img = frame.copy()
...
frame = mpimg.imread('/content/drive/MyDrive/Colab_Notebooks/DataSet/KoKo/F/0.jpg')
plt.imshow(frame)
